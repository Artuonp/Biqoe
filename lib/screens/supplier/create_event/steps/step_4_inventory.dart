        ...
        child: ListView(
          ...
          children: [
              ...
              child: Row(
                children: [
                  ...
                  _TypeCard(
                      ...
                      onTap: () => setState(() => _selectedType = 'flexible')),
                  const SizedBox(width: 10),
                  _TypeCard(
                      label: "Ticket\n(Eventos)",
                      icon: Icons.local_activity,
            ...
            TextFormField(
              ...
              decoration: _inputDeco(
                  label: "Precio total (en dólares)", icon: Icons.attach_money),
              validator: (v) => v!.isEmpty ? "Requerido" : null,
              onChanged: (val) =>
                  setState(() {}), // Actualizar vista para recálculo de cuotas
            ),
                      ...
                      children: [
                        Text(
                            ...
                            style: GoogleFonts.poppins(
                                fontWeight: FontWeight.bold,
                                color:
                                    (_calculateTotalPercentage() - 100).abs() <
                                            0.1
                                        ? kPrimaryColor
                                        : Colors.red)),
                      ],
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        subtitle: Text("$timeDisplay • ${item['cupos']} cupos"),
                        trailing: IconButton(
                          icon: const Icon(Icons.close,
                              color: Colors.red, size: 18),
                          onPressed: () =>
                              setState(() => _availabilityList.removeAt(index)),
                        ),
                      );
                    },
                  ),
